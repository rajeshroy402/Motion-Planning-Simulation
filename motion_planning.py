...
class MotionPlanning(Drone):
    ...
    def __init__(self, connection):
        ...
        self.check_state = {}
        self.global_goal = [-122.39734, 37.79259 , 30]
        #self.global_goal = [-122.397533, 37.792906 , 53]
        self.local_goal = [0.0, 0.0, 0.0]
    ...
    def plan_path(self):
        ...
        first_line = first_line.replace("lat0", "")
        first_line = first_line.replace("lon0", "")
        ...
        #grid_goal = (-north_offset + 10, -east_offset)
        # DONE: adapt to set goal as latitude / longitude position and convert
        self.local_goal[0], self.local_goal[1], self.local_goal[2] = global_to_local(self.global_goal, self.global_home)
